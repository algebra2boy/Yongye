...
<h2 class="text-sm font-medium text-gray-600 mt-1">
	...
	Subtopics include ciphers, hashes, key exchange, security services (integrity, availability,
	confidentiality, etc.), security attacks, vulnerabilities, anonymous communications, and
	countermeasures.
</h2>
...
<p class="mt-1 text-gray-700 text-sm font-mono">
	...
	practice of computer and network security. The most takeway from this course was understanding the
	importance of cryptography, privacy, and network security. The course covered cryptography like
	SHA and AES, public key infrastructure, and network security like firewalls, malwares, and so on.
	For the final project, I worked on a research paper on the topic of
	<a href="/pdf/SQLInjection.pdf" class="underline"> SQL Injection</a>, which you can find the
