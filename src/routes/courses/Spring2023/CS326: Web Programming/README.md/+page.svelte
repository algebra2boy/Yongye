...
<p class="mt-1 text-gray-700 text-sm font-mono">
	...
	event handling works. The amount and diversity of exercises and projects in this course were very
	helpful to understand the concepts. We worked a single project called Scrabble where we designed
	and implemented a web application that allows users to play a game of Scrabble. It was a great
	experience to work on a project that involves both front-end and back-end. The discussions are
	insanely helpful, and the professor Tim Richards is very knowledgeable. Yes, Tim Richards, what a
	great professor. I would highly recommend this course to anyone who wants to learn web
	programming. For the final project, I worked on a web application that allows students to leave
	feedback for dinning hall food, which is called
