...
<p class="mt-1 text-gray-700 text-sm font-mono">
	I took this course in the Spring of 2024. This course was interesting. First homework was to build
	a resume and cover letter. Second homework was to write a letter to a manager about advertisement.
	Third homework was to argue about unethical and ethical tools. Fourth homework was to write about
	a research paper. Fifth homework was to convince a high up manager to change a policy based on the
	research paper. For the research paper, I wrote about how Duolingo impacted the language learning
	enviornment in education. You can read the paper from here: <a
